" LSP stuff?
" TODO: Clean this section up. Maybe by actually going through the LSP
" installation/config thoroughly.
" - If I can mix `.vim` and `.lua` configuration files then this should
"   probably be in a `.lua` since it's all Lua anyway.
...
-- I already have this configured in my `set`s.
